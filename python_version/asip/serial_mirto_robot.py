from asip.serial_board import SerialBoard
from asip.services.bump_service import BumpService
from asip.services.encoder_service import EncoderService
from asip.services.ir_service import IRService
from asip.services.motor_service import MotorService
from asip.services.lcd_service import LCDService
import sys
import time
...
class SerialMirtoRobot(SerialBoard):
    ...
    def __init__(self):
        ...
        self.get_asip_client().add_service(self._lcd[0].get_service_id(), self._lcd)
    ...
    def set_LCD_message(self, message, line):
        self._lcd[0].set_LCD_message(message, line)
        sys.stdout.write("DEBUG: Writing: {} to line {} on the LCD\n".format(message,line))

    def clear_LCD(self):
        self._lcd[0].clear_LCD()
